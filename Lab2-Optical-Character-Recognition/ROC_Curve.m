...
text(FPR(index)+0.01,TPR(index),Text_on_plot2,'color','black','FontSize',10,'FontWeight','bold')

textspec23='FPR %.4f, TPR %.4f';
Text_on_plot23=sprintf(textspec23,FPR(index),TPR(index));
text(FPR(index)+0.01,TPR(index)-0.01,Text_on_plot23,'color','black','FontSize',10,'FontWeight','bold')